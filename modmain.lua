...
PrefabFiles = {"yurik", "yurik_none", "spiritbolt", "yurikflashlight", "yurikmedicine", "yurikwater", "yurikfire","yurikbattery",
               "yurik_camera", "yurik_ammo14","yurik_ammo61","yurik_ammo90","yurik_ammozero","yurik_waterprojectiles","yurikblacktea"}
              -- "yurikblacktea"
