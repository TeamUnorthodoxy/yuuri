local assets = {Asset("ANIM", "anim/yurik_ammo14.zip"),
                Asset("ATLAS", "images/inventoryimages/yurik_ammo14.xml"),
                Asset("IMAGE", "images/inventoryimages/yurik_ammo14.tex"),
                Asset("ATLAS_BUILD", "images/inventoryimages/yurik_ammo14.xml", 256) 
            }
...
local function fn(item)
    ...
    inst.AnimState:SetBank("yurik_ammo14")
    inst.AnimState:SetBuild("yurik_ammo14")
    ...
    inst.components.inventoryitem.imagename = "yurik_ammo14"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/yurik_ammo14.xml"
...
STRINGS.NAMES.YURIK_AMMO14 = "14式胶卷"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.YURIK_AMMO14 = [[蓝色包装的劣质胶卷]]
STRINGS.RECIPE_DESC.YURIK_AMMO14 = [[蓝色包装的劣质胶卷]]
