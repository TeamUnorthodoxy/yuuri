local assets = {Asset("ANIM", "anim/yurik_ammo90.zip"),
                Asset("ATLAS", "images/inventoryimages/yurik_ammo90.xml"),
                Asset("IMAGE", "images/inventoryimages/yurik_ammo90.tex"),
                Asset("ATLAS_BUILD", "images/inventoryimages/yurik_ammo90.xml", 256)
            }
...
local function fn(item)
    ...
    inst.AnimState:SetBank("yurik_ammo90")
    inst.AnimState:SetBuild("yurik_ammo90")
    ...
    inst.components.inventoryitem.imagename = "yurik_ammo90"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/yurik_ammo90.xml"
...
STRINGS.NAMES.YURIK_AMMO90 = "90式胶卷"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.YURIK_AMMO90 = [[红色包装的优质胶卷]]
STRINGS.RECIPE_DESC.YURIK_AMMO90 = [[红色包装的优质胶卷]]
