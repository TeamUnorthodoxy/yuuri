local assets = {Asset("ANIM", "anim/yurik_ammozero.zip"),
                Asset("ATLAS", "images/inventoryimages/yurik_ammozero.xml"),
                Asset("IMAGE", "images/inventoryimages/yurik_ammozero.tex"),
                Asset("ATLAS_BUILD", "images/inventoryimages/yurik_ammozero.xml", 256)
            }
...
local function fn(item)
    ...
    inst.AnimState:SetBank("yurik_ammozero")
    inst.AnimState:SetBuild("yurik_ammozero")
    ...
    inst.components.inventoryitem.imagename = "yurik_ammozero"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/yurik_ammozero.xml"
...
STRINGS.NAMES.YURIK_AMMOZERO = "零式胶卷"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.YURIK_AMMOZERO = [[感受到了核弹的质感！]]
STRINGS.RECIPE_DESC.YURIK_AMMOZERO = [[感受到了核弹的质感！]]
