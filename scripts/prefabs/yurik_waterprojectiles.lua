...
local yurikwaterballoon_assets =
{
    Asset("ANIM", "anim/yurikwaterballoon.zip"),
    Asset("ANIM", "anim/swap_yurikwaterballoon.zip"),
    Asset("ATLAS", "images/inventoryimages/yurikwaterballoon.xml"),
    Asset("IMAGE", "images/inventoryimages/yurikwaterballoon.tex"),
    Asset("ATLAS_BUILD", "images/inventoryimages/yurikwaterballoon.xml", 256)
}

local yurikwaterballoon_prefabs =
{
    "waterballoon_splash",
    "reticule",
}
...
local function onequip(inst, owner)
    owner.AnimState:OverrideSymbol("swap_object", "swap_yurikwaterballoon", "swap_yurikwaterballoon")
...
local function yurikwaterballoon_fn()
    --weapon (from weapon component) added to pristine state for optimization
    local inst = common_fn("yurikwaterballoon", "yurikwaterballoon", "idle", "weapon", true)
    ...
    inst.components.inventoryitem.imagename = "yurikwaterballoon"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/yurikwaterballoon.xml"
...
STRINGS.NAMES.YURIKWATERBALLOON = "高级水袋"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.YURIKWATERBALLOON = [[一袋更比五袋强]]
STRINGS.RECIPE_DESC.YURIKWATERBALLOON = [[一袋更比五袋强]]

return --Prefab("snowball", snowball_fn, snowball_assets, snowball_prefabs),
    Prefab("yurikwaterballoon", yurikwaterballoon_fn, yurikwaterballoon_assets, yurikwaterballoon_prefabs)
